...
n.addEventListener("click",(function(){fetch("https://tsiprojectfront.azurewebsites.net/api/films/random").then((function(n){if(!n.ok)throw new Error("Error fetching random film");
